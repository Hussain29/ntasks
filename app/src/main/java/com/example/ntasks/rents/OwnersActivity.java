...
public class OwnersActivity extends AppCompatActivity {
    ...
    private void openOwnerDetailsActivity(Owner owner) {
        ...
        intent.putExtra("owner", new Owner(owner.getOwnerId(), owner.getOwnerName(), owner.getOwnerAddress(), owner.getOwnerEmail(), owner.getOwnerPhone1(), owner.getOwnerPhone2(), owner.getOwnerPhone3(), owner.getOwnerNotes(), owner.getUserId(), owner.getPhotoUrl(), owner.getDocUrl(), owner.getDocType(), owner.getAge(), owner.getOccupation(), owner.getFathername()));
        startActivity(intent);
